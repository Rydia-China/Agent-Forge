    ...
    <main className="flex h-screen w-full bg-slate-950 text-slate-100">
      ...
      {showResources && (
        <div className="fixed inset-0 z-40 flex items-stretch justify-end bg-black/40 backdrop-blur-sm">
          <button className="absolute inset-0 h-full w-full cursor-pointer" onClick={() => setShowResources(false)} type="button" aria-label="Close" />
          <aside className="relative z-10 h-full w-72 overflow-y-auto border-l border-slate-800 bg-slate-950 p-4 shadow-2xl drawer-in">
            <div className="mb-3 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="text-[10px] text-slate-400 hover:text-white" onClick={() => setShowResources(false)} type="button">✕</button>
              </div>
            </div>
