            ...
            items: {
              ...
              items: {
                ...
                properties: {
                  ...
                  scopeType: { type: "string", enum: ["novel", "script"], description: "Scope level. Injected by context provider for internal agents; external callers must resolve from biz_db (novel_scripts table)." },
                  scopeId: { type: "string", description: "ID of the scope entity. Injected by context provider for internal agents; external callers must resolve from biz_db (novel_scripts table)." },
