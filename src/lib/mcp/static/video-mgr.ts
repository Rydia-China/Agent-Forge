            ...
            items: {
              ...
              items: {
                ...
                properties: {
                  ...
                  category: { type: "string", description: "Resource category for UI grouping (LLM decides, e.g. '角色立绘', '场景', '服装')" },
            ...
            items: {
              ...
              items: {
                ...
                properties: {
                  ...
                  category: { type: "string", description: "Resource category for UI grouping (e.g. '视频', '片头', '转场')" },
